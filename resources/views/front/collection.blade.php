          ...
          <section class="ftco-section-3">
              <div class="photograhy">
                  <div class="row">
                      ...
                      <div class="col-md-4 ftco-animate">
                          <a href="{{ asset('assets') }}/images/image_4.jpg"
                              class="photography-entry img image-popup d-flex justify-content-start align-items-end"
                      ...
                      <div class="col-md-4 ftco-animate">
                          <a href="{{ asset('assets') }}/images/image_5.jpg"
                              class="photography-entry img image-popup d-flex justify-content-start align-items-end"
                      ...
                      <div class="col-md-4 ftco-animate">
                          <a href="{{ asset('assets') }}/images/image_6.jpg"
                              class="photography-entry img image-popup d-flex justify-content-start align-items-end"
                      ...
                      <div class="col-md-4 ftco-animate">
                          <a href="{{ asset('assets') }}/images/image_7.jpg"
                              class="photography-entry img image-popup d-flex justify-content-start align-items-end"
                      ...
                      <div class="col-md-4 ftco-animate">
                          <a href="{{ asset('assets') }}/images/image_8.jpg"
                              class="photography-entry img image-popup d-flex justify-content-start align-items-end"
                      ...
                      <div class="col-md-4 ftco-animate">
                          <a href="{{ asset('assets') }}/images/image_9.jpg"
                              class="photography-entry img image-popup d-flex justify-content-start align-items-end"
                              style="background-image: url({{ asset('assets') }}/images/image_9.jpg);">
                              <div class="overlay"></div>
                              <div class="text ml-4 mb-4">
                                  <h3>Photo 09</h3>
                      ...
                      <div class="col-md-4 ftco-animate">
                          <a href="{{ asset('assets') }}/images/image_10.jpg"
                              class="photography-entry img image-popup d-flex justify-content-start align-items-end"
                              style="background-image: url({{ asset('assets') }}/images/image_10.jpg);">
                              <div class="overlay"></div>
                              <div class="text ml-4 mb-4">
                                  <h3>Photo 10</h3>
                                  <span class="tag">Model</span>
                      ...
                      <div class="col-md-4 ftco-animate">
                          <a href="{{ asset('assets') }}/images/image_11.jpg"
                              class="photography-entry img image-popup d-flex justify-content-start align-items-end"
                              style="background-image: url({{ asset('assets') }}/images/image_11.jpg);">
                              <div class="overlay"></div>
                              <div class="text ml-4 mb-4">
                                  <h3>Photo 11</h3>
                                  <span class="tag">Fashion</span>
                      ...
                      <div class="col-md-4 ftco-animate">
                          <a href="{{ asset('assets') }}/images/image_12.jpg"
                              class="photography-entry img image-popup d-flex justify-content-start align-items-end"
                              style="background-image: url({{ asset('assets') }}/images/image_12.jpg);">
                              <div class="overlay"></div>
                              <div class="text ml-4 mb-4">
                                  <h3>Photo 12</h3>
