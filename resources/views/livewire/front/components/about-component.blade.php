         ...
         <div class="hero-wrap">
             ...
             <div class="d-flex">
                 <div class="author-image text img p-md-5"
                     style="background-image: url({{ asset('assets') }}/images/author.jpg);">

                 </div>
                 <div class="author-info text p-4 p-md-5 mt-5 mb-5">
                     <div class="desc">
                         <span class="subheading">Nice To Meet You</span>
                         <h1 class="big-letter">{{ $settings->about_title }}</h1>
                         <h1 class="mb-4"><span>My Name is {{ $settings->about_title }}</span></h1>
                         ...
                         <ul class="ftco-social mt-3">
                             ...
                             <li class="ftco-animate"><a href="{{ $settings->facebook }}"><span
                                         class="icon-facebook"></span></a>
                             </li>
                             <li class="ftco-animate"><a href="{{ $settings->instagram }}"><span
         ...
         <div class="container">
             ...
             <div class="row no-gutters">
                ...
                <div class="col-sm-12 col-md ftco-animate">
                    <a href="{{ $photo->getUrl() }}" class="insta-img image-popup"
                ...
                @endforeach
                 {{-- <div class="col-sm-12 col-md ftco-animate">
                     <a href="{{ asset('assets') }}/images/image_2.jpg" class="insta-img image-popup"
                 ...
                 <div class="col-sm-12 col-md ftco-animate">
                     <a href="{{ asset('assets') }}/images/image_3.jpg" class="insta-img image-popup"
                 ...
                 <div class="col-sm-12 col-md ftco-animate">
                     <a href="{{ asset('assets') }}/images/image_4.jpg" class="insta-img image-popup"
                 ...
                 <div class="col-sm-12 col-md ftco-animate">
                     <a href="{{ asset('assets') }}/images/image_5.jpg" class="insta-img image-popup"
